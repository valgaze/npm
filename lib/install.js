...
Installer.prototype.executeActions = function (cb) {
  ...
  steps.push(
    ...
    [doSerialActions, 'allinstall', staging, todo, trackLifecycle.newGroup('allinstall')],
...
Installer.prototype.runPostinstallTopLevelLifecycles = function (cb) {
  ...
  steps.push(
    [doOneAction, 'allinstall', this.idealTree.path, this.idealTree, trackLifecycle.newGroup('allinstall:.')],
